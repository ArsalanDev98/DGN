...
const faqData = [
  {
    ...
    answer: "The bot can be found on telegram, you can search @betloungepvp_bot or click here: https://t.me/betloungepvp_bot",
  },
  {
  ...
  },
  {
    ...
    answer: "Sometimes this can be due to the conversation flow within the bot. Do the command /cancel to reset the bot. This should work most of the time.",
  },
  {
    question: "I'm in a group with an active game, but I can’t see it. How can I fix it?",
    answer: "Whenever a match has been activated, the bot will send a notification with a link to the group it's in. If you do not see it from the bot, then go to the community link and click from there.",
  },
  {
