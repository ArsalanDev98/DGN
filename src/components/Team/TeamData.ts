...
const teamMembers = [
  {
    name: "Chuni",
    title: "CEO",
    description: "Finance & Economics background with 7+ years of experience in Crypto. Worked with multiple 8-9 fig projects.",
    image: chuniGif,
  ...
  },
  {
    ...
    title: "CSO/Growth",
    description: "Real estate investor, 7 years experience in crypto, onboarded $100M+ companies into web3.",
    image: nicoImage,
    icons: [xIcon, telegramIcon, linkedinIcon],
    urls: ["https://x.com/0xnicott", "https://t.me/OxMachiavelli", "https://www.linkedin.com/in/nico-machiavelli"]
  },
  {
    name: "Malz, Arsalan, Tom Bateman",
    title: "Development Team",
    description: "20 years experience in full stack development. Multiple solidity and commercial deployments.",
    image: tomImage,
    icons: [xIcon, telegramIcon, linkedinIcon],
    urls: ["https://x.com/Tom__DeFi", "https://t.me/tom_defi", "https://www.linkedin.com/in/tom-defi"]
  },
  {
    name: "Sonic, Elevated and TraderB",
    title: "Marketing Team",
    description: "Over 15 years combined experience in crypto. Veteran advisors and builders for large utility projects.",
    image: elevatedGif,
    icons: [xIcon, telegramIcon],
